...
urlpatterns = [
    ...
    path('order/<int:nid>/edit/', order.edit_normal),
    path('order/edit_ajax/', order.edit_ajax),
    path('order/edit_ajax_return/', order.edit_ajax_return),
    
    path('order/delete/', order.delete_normal),
    path('order/delete_ajax/', order.delete_ajax),
