        ...
        <div class="container">
            ...
            <div class="drag-box">
                <div class="drag-box-item" v-for="item in info" :key="item.id">
                    ...
                    <draggable v-model="item.data" @remove="removeHandle" :options="dragOptions">
                        <transition-group tag="div" id="" class="item-ul">
                            <div v-for="element in item.data" :key="element.id">
                                <div v-if="element.danger_count == 1" class="drag-list_red" key="1">危险箱</div>
                                <div v-if="element.normal_count == 1" class="drag-list_yellow" key="2">普通箱</div>
                                <div v-if="element.cold_count == 1" class="drag-list_blue" key="3">冷藏箱</div>
                                <div v-if="element.over_count == 1" class="drag-list_brown" key="4">超限箱</div>
                            </div>
                        </transition-group>
                    </draggable>
                </div>
            ...
            <el-pagination background layout="prev, pager, next" :total="100" @current-change="handlePageChange"> </el-pagination>
            <!-- <div class="drag-box">
    ...
    methods: {
        selectchange() {
            ...
            Axios({
                ...
                console.log(res);
                this.info = res.data.info.slice(0, 10);
                this.temp_info = res.data.info;
        ...
        handlePageChange(val) {
            this.info = this.temp_info.slice(0+10*(val-1), 10+10*(val-1));
